...
/// @nodoc
@JsonSerializable()
class _$_Brand with DiagnosticableTreeMixin implements _Brand {
  const _$_Brand({required this.bannerUrl});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Brand(bannerUrl: $bannerUrl)';
  }
...
abstract class _Brand implements Brand {
  const factory _Brand({required final String bannerUrl}) = _$_Brand;
